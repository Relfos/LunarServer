...
namespace SynkServer.Minifiers
{
    ...
    public sealed class HTMLMinifier 
    {
         ...
         */
        public bool RemoveIntertagSpaces = true;
         ...
         * Default is <code>false</code>
         */
        public bool CompressJavaScript = true;
         ...
         */
        public bool SimpleBooleanAttributes = true;
        ...
        {
            var compressor = new HTMLMinifier();
        ...
        private string compressJavaScript(string source)
        {
            ...
            //if dont want compress =>   return source;
            ...
            string result = JSMinifier.Compress(source);
        ...
        private string compressCssStyles(string source)
        {
            ...
            string result = CSSMinifier.Compress(source);
        ...
        private HTMLMinifier createCompressorClone()
        {
            var clone = new HTMLMinifier
            {
